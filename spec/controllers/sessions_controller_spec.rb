...
describe SessionsController do
  ...
  before do 
    @user  = mock_user
    @login_params = { :email => '23impressions@gmail.com', :password => 'test' }
  ...
  describe "on failed login" do
    before do
      ...
      login_as :impressions
    end
    it 'logs out keeping session'   do controller.should_receive(:logout_keeping_session!); do_create end
    it 'flashes an error'           do do_create; flash[:error].should =~ /Couldn't log you in as '23impressions@gmail.com'/ end
